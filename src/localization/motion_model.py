...
class MotionModel:
    ...
    def __init__(self):
        ...
        self.x_scale = rospy.get_param('~noise_scale_x', 0.1) # 0.01
        self.y_scale = rospy.get_param('~noise_scale_y', 0.1) # 0.01
        self.theta_scale = rospy.get_param('~noise_scale_theta', np.pi/180) # pi/360
